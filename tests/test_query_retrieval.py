...
def test_main_exports_ranked_candidates(tmp_path: Path) -> None:
    ...
    corpus_rows = [
        json.loads((FIXTURES_DIR / "mini_corpus.jsonl").read_text(encoding="utf-8").strip()),
        {
            "paper_id": "10_1016_j_matdes_2019_108076",
            "chunk_id": "10_1016_j_matdes_2019_108076:text:001",
            "source_type": "text",
            "text": "Mechanical properties of lightweight 316L stainless steel lattice structures fabricated by selective laser melting.",
            "page_no": 1,
            "figure_id": None,
    ...
    assert payload["candidates"][0]["chunk_id"] == "10_1016_j_compositesb_2019_107565:text:001"
